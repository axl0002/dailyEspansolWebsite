        ...
        <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 font-sans">
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <section className="space-y-4">
                    ...
                    <p>
                        If you are experiencing issues with the Daily Español app, have questions about your subscription, or want to provide feedback, please don&#39;t hesitate to reach out.
                    </p>
                    <p>
                    ...
                    <div className="pt-4">
                        <a
                            href="mailto:support@dailyespanol.app"
                        ...
                        <p className="mt-2 text-sm text-foreground/60">
                            or write to us at <a href="mailto:support@dailyespanol.app" className="text-primary hover:underline">support@dailyespanol.app</a>
                        </p>
                    </div>
                </section>
